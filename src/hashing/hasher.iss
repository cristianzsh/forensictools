...
[Icons]
Name: "{group}\{#MyAppName}\Hasher"; Filename: "{app}\hashing\Hasher\Hasher.exe"; Components: "hashing\Hasher"
Name: "{app}\sendto+\sendto\Hashing\Hasher"; Filename: "{app}\hashing\Hasher\Hasher.exe"; Components: "hashing\Hasher"