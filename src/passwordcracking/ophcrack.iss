...
[Icons]
Name: "{group}\{#MyAppName}\Ophcrack"; Filename: "{app}\passwordcracking\ophcrack\ophcrack.exe"; Components: "passwordcracking\ophcrack"
Name: "{app}\sendto+\sendto\Password cracking\Ophcrack"; Filename: "{app}\passwordcracking\ophcrack\ophcrack.exe"; Components: "passwordcracking\ophcrack"