...
[Icons]
Name: "{group}\{#MyAppName}\LastActivityView"; Filename: "{app}\windowsartifacts\lastactivityview\LastActivityView.exe"; Components: "windowsartifacts\lastactivityview"
Name: "{app}\sendto+\sendto\Windows artifacts\LastActivityView"; Filename: "{app}\windowsartifacts\lastactivityview\LastActivityView.exe"; Components: "windowsartifacts\lastactivityview"