...
[Icons]
Name: "{group}\{#MyAppName}\JumpListExplorer"; Filename: "{app}\windowsartifacts\jumplistexplorer\JumpListExplorer.exe"; Components: "windowsartifacts\jumplistexplorer"
Name: "{app}\sendto+\sendto\Windows artifacts\JumpListExplorer"; Filename: "{app}\windowsartifacts\jumplistexplorer\JumpListExplorer.exe"; Components: "windowsartifacts\jumplistexplorer"