...
[Icons]
Name: "{group}\{#MyAppName}\WFA"; Filename: "{app}\windowsartifacts\wfa\WFA.exe"; Components: "windowsartifacts\wfa"
Name: "{app}\sendto+\sendto\Windows artifacts\WFA"; Filename: "{app}\windowsartifacts\wfa\WFA.exe"; Components: "windowsartifacts\wfa"