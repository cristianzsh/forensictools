...
[Icons]
Name: "{group}\{#MyAppName}\SDBExplorer"; Filename: "{app}\windowsartifacts\SDBExplorer\SDBExplorer.exe"; Components: "windowsartifacts\sdbexplorer"
Name: "{app}\sendto+\sendto\Windows artifacts\SDBExplorer"; Filename: "{app}\windowsartifacts\SDBExplorer\SDBExplorer.exe"; Components: "windowsartifacts\sdbexplorer"