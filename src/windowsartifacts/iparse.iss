...
[Icons]
Name: "{group}\{#MyAppName}\$I Parse"; Filename: "{app}\windowsartifacts\iparse\I_Parse.exe"; Components: "windowsartifacts\iparse"
Name: "{app}\sendto+\sendto\Windows artifacts\$I Parse"; Filename: "{app}\windowsartifacts\iparse\I_Parse.exe"; Components: "windowsartifacts\iparse"