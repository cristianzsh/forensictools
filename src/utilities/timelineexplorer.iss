...
[Icons]
Name: "{group}\{#MyAppName}\Timeline Explorer"; Filename: "{app}\utilities\timelineexplorer\TimelineExplorer.exe"; Components: "utilities\timelineexplorer"
Name: "{app}\sendto+\sendto\Utilities\Timeline Explorer"; Filename: "{app}\utilities\timelineexplorer\TimelineExplorer.exe"; Components: "utilities\timelineexplorer"