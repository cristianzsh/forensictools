...
[Icons]
Name: "{group}\{#MyAppName}\OfficeMalScanner"; Filename: "{app}\utilities\officemalscanner\runOMS.bat"; Components: "utilities\officemalscanner"
Name: "{app}\sendto+\sendto\Utilities\OfficeMalScanner"; Filename: "{app}\utilities\officemalscanner\runOMS.bat"; Components: "utilities\officemalscanner"