...
[Icons]
Name: "{group}\{#MyAppName}\DB Browser for SQLite"; Filename: "{app}\utilities\dbbrowser\DB Browser for SQLite.exe"; Components: "utilities\dbbrowser"
Name: "{app}\sendto+\sendto\Utilities\DB Browser for SQLite"; Filename: "{app}\utilities\dbbrowser\DB Browser for SQLite.exe"; Components: "utilities\dbbrowser"