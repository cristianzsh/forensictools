...
[Icons]
Name: "{group}\{#MyAppName}\TrID"; Filename: "{app}\utilities\trid\runTrID.bat"; Components: "utilities\trid"
Name: "{app}\sendto+\sendto\Utilities\TrID"; Filename: "{app}\utilities\trid\runTrID.bat"; Components: "utilities\trid"