...
[Icons]
Name: "{group}\{#MyAppName}\MFTExplorer"; Filename: "{app}\mft\mftexplorer\MFTExplorer.exe"; Components: "mft\mftexplorer"
Name: "{app}\sendto+\sendto\MFT\MFTExplorer"; Filename: "{app}\mft\mftexplorer\MFTExplorer.exe"; Components: "mft\mftexplorer"