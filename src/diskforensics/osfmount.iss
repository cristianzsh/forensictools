...
[Icons]
Name: "{group}\{#MyAppName}\OSFMount"; Filename: "{app}\diskforensics\osfmount\OSFMount.exe"; Components: "diskforensics\osfmount"
Name: "{app}\sendto+\sendto\Disk forensics\OSFMount"; Filename: "{app}\diskforensics\osfmount\OSFMount.exe"; Components: "diskforensics\osfmount"